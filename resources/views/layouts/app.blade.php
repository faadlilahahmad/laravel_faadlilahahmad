...
<html lang="en">
    <head>
        ...
        <style>
            ...
            .navbar {
                background-color: #0277bd; /* Warna biru untuk navbar */
            }
            .sb-sidenav-dark {
                background-color: #01579b; /* Warna biru gelap untuk sidebar */
            }
            .sb-nav-link-icon, .nav-link, .sb-sidenav-menu-heading {
                color: #bbdefb; /* Warna teks biru pucat */
            }
            .nav-link.active {
                background-color: #0288d1; /* Warna biru terang untuk link aktif */
                color: white;
            }
            .btn-link {
                color: #0288d1; /* Warna biru untuk tombol */
            }
        </style>
    </head>
